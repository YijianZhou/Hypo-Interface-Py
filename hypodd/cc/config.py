...
class Config(object):
  def __init__(self):
    ...
    self.fpha_name = 'input/eg_name.pha'
    self.fpha_ot = 'input/eg_ot.pha'
    self.fpha_loc = 'input/eg_loc.pha'
    ...
    self.win_data_p = [1.5,2.5]    # longer than temp, include uncertainty
    self.win_data_s = [1.,3.]
